...
const data = {
  ...
  profile: {
    about: [
      { property: 'Full Name', value: 'Gregor Wallner', icon: 'tabler:user' },
      { property: 'Status', value: 'active', icon: 'tabler:check' },
      { property: 'Role', value: 'CEO', icon: 'tabler:crown' },
      { property: 'Country', value: 'Österreich', icon: 'tabler:flag' },
      { property: 'Language', value: 'Deutsch', icon: 'tabler:language' }
    ],
    contacts: [
